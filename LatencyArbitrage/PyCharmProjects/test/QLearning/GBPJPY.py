        ...
        while True:
            ...
            if data1[1] == data2[1]:
                ...
                if MIN_DELAY > time1_sec - time2_sec > 0:
                    if mid2 - mid1 <= -DELTA_TICKS:  # Buy on Second
                    ...
                    elif mid1 - mid2 <= -DELTA_TICKS:  # Sell on Second
